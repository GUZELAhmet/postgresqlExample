...
--parent ta 105 olmadığı için veri girişi yapamayız.
...
-- child tablodaki veri silinmeden paretntteki veri silinemez

--SORU 5: child tablosundaki ted_vergino 101 olan verileri siliniz
delete from child where ted_vergino=101; (edited) 
...
--chil tablo silinmeden parent silinemez
...
drop table parent2 cascade; --on delete cascade sayesinde silindi
